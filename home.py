...
if number_areas_Laatvlieger>0:
  ...
  days_work_Laatvlieger = number_areas_Laatvlieger*Laatvlieger_days
...
if number_areas_Kraamverblif>0:
  ...
  days_work_Kraamverblif = number_areas_Kraamverblif*Kraamverblif_days
  days_off = days_Kraamverblif - days_work_Kraamverblif
  days_off_percent = round((days_off*100)/days_Kraamverblif)
  st.write(f"If you cover {number_areas_Kraamverblif} areas during the Kraamverblif period you will work {days_work_Kraamverblif} days, and {days_off} days off which is the {days_off_percent}% of the total number in that peroid")  
